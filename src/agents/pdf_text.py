...
DOCUMENTS = [
    ...
    # under data/claims/extracted_text/. Like the other datasheets the PDF is
    # not redistributed, so in the public release build_all() reports it MISSING
    # and leaves the snapshot untouched; with the PDF present the extraction
    # reproduces that snapshot byte for byte.
